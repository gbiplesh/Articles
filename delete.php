...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  ...
  <div class="w3-content w3-padding-64 w3-text-grey w3-xlarge"> 
    <?php
        ...
        //Delete Data           
        $delete = mysqli_query($conn, "DELETE FROM articles 
                    WHERE heading = '$heading'");   
          
          if(!$delete) {
            die(mysql_error($conn));
          } else {
            echo '<h2 align= "center" style="color:green;">Article Deleted Successfully!</h2>';
          }
        }
    ?>
 ...
 <a href="index.php" target="_blank">View Articles</a><br>
  ...
  <form action="" method="POST" target="_self"">
    ...
    <table width="100%" cellpadding="5px">
      <tr>
        <th>Delete article from: </th>
        <td><input type="text" name="heading" placeholder=" Current Heading"></td>
      </tr>
       <tr>
        <th></th>
        <td>
