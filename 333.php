...
session_start();
  ...
  if(isset($_POST["submit"])) {
    ...
    $query =  mysqli_query($conn, "SELECT  * FROM admins WHERE legal = '1'") 
    or die("Failed to query database".mysqli_error($conn));    
 
   $row = mysqli_fetch_array($query);      

   if ($row['adminUser'] == $username && $row['password'] == $password)    {   
      ...
      echo "<h3 style='font-weight: bold; color: red; text-align: center;'>Invalid Admin Found!</h3>";
    }   
